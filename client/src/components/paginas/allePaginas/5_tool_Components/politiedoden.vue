...
<div>
    <div class="content-20vh flexCenter">
        <div class="totaal flexCenter">
            <p>PolitieDoden</p>
            <p class="aantal">{{active.dodelijke}}</p>
        </div>
    </div>
    <div class="keuzes">
        <nav>
            ...
            <div class="svgContainer">
                <svg v-for="(a,index) in active.schietincidenten" v-bind:key="'A'+index" class="stickfigure" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 232.8 626"><title>politie-agent2</title>
                    <g>
...
export default { 
    ...
    methods:{
        ...
        coloring(){
            this.$el.querySelectorAll('svg').forEach((i, index)=>{
